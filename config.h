...
static Key keys[] = {
	...
	{ 0,                 XK_s,      setlayout,      {.v = &layouts[2]} },
	{ 0,                 XK_f,      setlayout,      {.v = &layouts[3]} },
	{ 0,                 XK_space,  setlayout,      {0} },
	{ ShiftMask,         XK_space,  togglefloating, {0} },
	{ 0,                 XK_0,      view,           {.ui = 0 } },
	{ ControlMask,       XK_0,      toggleview,     {.ui = ~0 } },
	{ ShiftMask,         XK_0,      tag,            {.ui = ~0 } },
	{ 0,                 XK_comma,  focusmon,       {.i = -1 } },
	{ 0,                 XK_period, focusmon,       {.i = +1 } },
	{ ShiftMask,         XK_comma,  focustagmon,    {.i = -1 } },
	{ ShiftMask,         XK_period, focustagmon,    {.i = +1 } },
	{ ControlMask,       XK_comma,  tagmon,         {.i = -1 } },
	{ ControlMask,       XK_period, tagmon,         {.i = +1 } },
	{ 0,                 XK_g,      handle_browser, SHCMD("browser") },
	{ 0,                 XK_o,      spawn,          SHCMD("monitor detect") },
	{ 0,                 XK_r,      restart,        {0} },
	TAGKEYS(             XK_1,                      0)
	TAGKEYS(             XK_2,                      1)
	TAGKEYS(             XK_3,                      2)
